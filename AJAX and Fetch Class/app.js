...
const smartyApiKey = '25731133668897616'; // replace with your API key
...
const smartyUrl = 'https://explorecaliforniaajaxproxy.herokuapp.com/streets/street-address?candidates=10';




// const parksUrl = `https://developer.nps.gov/api/v1/parks?stateCode=CA&api_key=p37gUftzQgeb61BZpCegBquiJlyyhaBubd0xpCKU`
const parksUrl = 'https://explorecaliforniaajaxproxy.herokuapp.com/nps/api/v1/parks?stateCode=ca';
