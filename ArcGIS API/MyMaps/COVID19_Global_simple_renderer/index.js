		...
		visualVariables: [
			{
				...
				field: 'Confirmed', // total population in poverty
				minDataValue: 1000, // features where < 10% of the pop in poverty
				maxDataValue: 1300000, // features where > 30% of the pop in poverty
